...
import SpellsContextProvider, { SpellCTX } from "../store/spell-context";

export default function TabContents({ selectedTab }) {
  return (
    <div>
      <SpellsContextProvider>
        {selectedTab === "ARMY" && <Army></Army>}
        {selectedTab === "TRAIN-TROOPS" && <TrainArmy></TrainArmy>}
        {selectedTab === "BREW-SPELLS" && <BrewSpell></BrewSpell>}
        {selectedTab === "BUILD-SIEGE" && <SiegeMachine></SiegeMachine>}
